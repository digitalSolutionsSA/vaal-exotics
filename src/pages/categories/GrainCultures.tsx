...
export default function GrainCultures() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      // We want products to show even if stock_count = 0.
      ...
      if (error) {
        console.error("GrainCultures fetch error:", error);
        setProducts([]);
        setLoading(false);
        return;
      }
  ...
  // Safety net in case older DB rows had inconsistent category strings
