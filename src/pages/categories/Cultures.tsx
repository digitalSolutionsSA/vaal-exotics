...
import culturesBg from "../../assets/new-bg.png";
import ProductQuickView from "../../components/ProductQuickView";
import { CATEGORY } from "../../lib/category";

const CAT = CATEGORY.cultures;
...
export default function Cultures() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      if (error) {
        console.error("Cultures fetch error:", error);
        setProducts([]);
        setLoading(false);
        return;
      }
  ...
  return (
    <main className="relative min-h-screen text-black">
      <div
        ...
        style={{
          backgroundImage: `url(${culturesBg})`,
      ...
      <div className="relative z-10 mx-auto w-full max-w-[2400px] px-4 sm:px-5 lg:px-6 pt-12 sm:pt-14 pb-20">
        ...
        >
          Premium culture products for reliable, clean, and consistent cultivation.
        </p>
